...
# Installation
    ...
    git clone https://github.com/Ninja-Yubaraj/Bash-Insulter.git bash-insulter
    sudo cp bash-insulter/src/bash.command-not-found /etc/

    # Method 2 - I don't care, insult me!
    sudo wget -O /etc/bash.command-not-found https://raw.githubusercontent.com/Ninja-Yubaraj/bash-insulter/main/src/bash.command-not-found
